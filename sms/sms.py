...
load_dotenv(dotenv_path="C:/Users/MWANGOLO/Desktop/BushHack/sms/key.env")

# Africa's Talking credentials and API keys
username = os.getenv("AFRICASTALKING_USERNAME", "sandbox")
api_key1 = os.getenv("AFRICASTALKING_API_KEY", "atsk_270b81b1a053f8d1b6e68902c310417691cb36e31e88d3d07f539cb5be159dc2540e0b48")
shortcode = os.getenv("AFRICASTALKING_SHORTCODE", "20702")  # Replace with your actual shortcode
